    ...
    <Container>
      <section id="about">
        <div className="about-grid">
          <Card>
            <div className="section-tag">About Digital Drive Resource Private Limited</div>
          ...
          <Card>
            <h3>Our Story</h3>
            <p>
              Digital Drive Resource Private Limited was founded with a vision to help businesses in the digital world.
